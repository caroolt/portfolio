...
const Cards = () => {
  ...
  return (
    <div id="hero-cards" className="z-50 w-11/12 md:w-3/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-32 md:-translate-y-28 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-9">
    {cards.map((card: CardProps, index: number) => (
     <div  key={index}
     className="opacity-0 text-gray-600 flex flex-col items-start gap-3 py-6 px-5 rounded-[20px] min-h-[100px] relative"
     style={{
